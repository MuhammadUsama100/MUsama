        ...
        <div className="space-y-8">
          {filteredPublications.length === 0 ? (
            ...
            filteredPublications.map((publication) => (
              <Card
                key={publication.id}
                className="p-4 md:p-6 hover:border-accent transition-colors cursor-pointer"
              ...
              >
                <div className="flex flex-col-reverse md:flex-row gap-4 md:gap-6">
                  <div className="flex-1 min-w-0">
                    ...
                    <h3 className="text-xl md:text-2xl font-semibold text-primary mb-2 break-words">
                      {publication.title}
                    </h3>
                  ...
                  {publication.teaserImage && (
                    <div className="w-full md:w-96 h-48 md:h-64 flex-shrink-0">
                      <img
                        src={
